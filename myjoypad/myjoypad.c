...
void readBuffer()
{
    ...
    // one second, used with the usleep() function to make buffer output more readible 
    useconds_t one_second = 1000 * 1000;
    // the results of read--should be -1 if there's no events left in the Q 
    int r; 
    // basically, while read result not equal to -1 
